                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            required
                            placeholder="info@hanitsolutionsfl.com"
                            className="border-border/50 focus:border-accent/50 transition-colors duration-300"
                          />
                        </div>
                      </div>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex items-start space-x-3 group/item hover:bg-accent/5 p-2 rounded-lg transition-colors duration-300">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">(448) 216-5141</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3 group/item hover:bg-accent/5 p-2 rounded-lg transition-colors duration-300">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">info@hanitsolutionsfl.com</p>
                    </div>
                  </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-muted/30 via-accent/5 to-success/5">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="aspect-video rounded-lg overflow-hidden shadow-xl border border-accent/20 group hover:shadow-2xl transition-all duration-500">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3592.(448) 216-5141!2d-80.4234567!3d25.7234567!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x88d9c3e12345678%3A0x1234567890abcdef!2s14301%20SW%2031st%20St%2C%20Miami%2C%20FL%2033175!5e0!3m2!1sen!2sus!4v1234567890123!5m2!1sen!2sus"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
